...
WebviewWindow::WebviewWindow(
  ...
  // Use a plain GTK header bar instead of an embedded secondary Flutter engine.
  // The secondary fl_view_new() engine tears down on window close and corrupts
  // the primary engine's EGL context, crashing the app.
  auto *header_bar = gtk_header_bar_new();
